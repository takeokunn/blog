...
#+end_quote
*** emacs-jpラジオ
「vim-jp slackのtech-emacsチャンネルはemacs-jpより盛り上がってる」と言われるようになってしまい、emacs-jpの皆さん申し訳ない。
*** ゴリラさんからのお便り
#+begin_quote
...
#+end_export
*** モーダルとモードレス
モードレスに体が慣れすぎてるので、たまにvimを使うと「insertモードは素潜りしてる状態」に慣れないですね。
*** Emacsキーバインドについて
...
Dvorak配列にはn回挑戦していますが一向に身につかなくて中々厳しいです。
*** 小指について
Emacsユーザで小指が痛いって言ってる人本当に見たことがないですね。
...
不思議な仕様ですね。Vimでできることが少なすぎて大変そうだなと常に思ってる。
*** 定義ジャンプ
...
*** dwim文化
[[https://en.wikipedia.org/wiki/DWIM][DWIM (do what I mean)]] 文化はEmacs以外で見たことがないですね。他にもあれば教えてもらいたいです。
ラジオでも話しましたが、Emacs上では =M-x comment-dwim= が一番一般的ですね。

「一つのことをうまくやる」UNIX文化とは真逆の世界のように感じられます。
*** Emacs普及してない
素の状態は難しいし、Emacs Lispも初見だと難しいですよね。

40〜50歳のベテランがボリュームゾーンだろうなという感覚なので、やはり若手の自分が盛り上げていくしかないという感覚が常にあります。
...
#+end_export
*** 流行りは巡るもの
「全ての道はEmacsに通じる」のでみんなEmacsに辿りつくと思っています。
