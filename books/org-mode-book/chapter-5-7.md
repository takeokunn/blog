...
## :ATTACH<sub>DIR</sub><sub>INHERIT</sub>: - 継承設定
...
## <file:///build/zenn/org/books/org-mode-book/filename> 形式
...
## ![](/build/zenn/org/books/org-mode-book/image.png) の表示
...
\#+begin<sub>src</sub> emacs-lisp ;; 会議用テンプレート (add-to-list 'org-capture-templates '("m" "Meeting" entry （file+headline "~/org/meetings.org" "Meetings"） "\* TODO %<sup>Meeting Title</sup> SCHEDULED: %<sup>T</sup>
