...
今まではGoogle Slideでスライドを作成していたが、今回は [[id:C6F8F599-5F2A-4C8C-8148-0DF03644CE35][Typstテーマを自作した]] にもある通り自作テーマで初の登壇仕様を作成してみた。
...
見栄えの良いスライドをorg-modeとTypstで簡単に作成できた。

[[id:0D13FCEA-F8EC-4729-B700-9A88FD1D5EB9][NixでTypstをBuildしGitHub Pagesでホスティングする]] にもある通り、 =git push= したら数分後にGitHub Pagesからアクセスできるようになるので体験が非常に良い。
